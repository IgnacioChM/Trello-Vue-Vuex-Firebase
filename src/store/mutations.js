...
export default {
    ...
    [types.FETCH_BOARDS_SUCCESS] (state, { boards }){
        ...
        state.error = null
        state.boards = { ...boards} //concatena objetos los tres puntos (como un push)
    },
    ...
    [types.FETCH_LISTS_SUCCESS] (state, { lists }){
        state.fetchingData = false
        state.error = null
        state.lists = { ...lists} //concatena objetos los tres puntos (como un push)
    },
    ...
    [types.FETCH_TASKS_SUCCESS] (state, { tasks }){
        state.fetchingData = false
        state.error = null
        state.tasks = { ...tasks} //concatena objetos los tres puntos (como un push)
    },
    ...
    //Crear una nueva tarea a una lista
